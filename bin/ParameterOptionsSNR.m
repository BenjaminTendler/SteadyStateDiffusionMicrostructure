function [optScanner,optSample,optSSFP,optSTE,optSE] = ParameterOptionsSNR()
%%
%Scanner properties
...
optSSFP.tau=5;                                  % Diffusion Gradient Duration (ms)
optSSFP.TR=10;                                  % Repetition Time (ms)
optSSFP.alpha=10;                               % Flip angle (o)
%%
%Initial sequence parameters - STE (Note: Mixing time estimated in STE code from b-value definition) 
optSTE.G=optScanner.GMax;                       % Diffusion Gradient Amplitude (mT/m)
optSTE.tau=2.5;                                 % Diffusion Gradient Duration (ms)
optSTE.TR=1000;                                 % Repetition Time (ms)
optSTE.TE=2*optSTE.tau+10;                      % Echo Time (ms)
%%
