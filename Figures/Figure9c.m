...
%%
%Define T2 array - Note that fitting algorithm will fix the gradient amplitude to GMax during the fitting (defined in ParameterOptionsSNR)
T2Arr=1.25:1.25:50;
%%
...
%%
%SSFP Optimisation
for k=length(T2Arr):-1:1
    optSample.T2=T2Arr(k);
...
%%
%Plot
figure;plot(T2Arr,(SNR_eff_SSFP*100),'linewidth',4)
hold all;plot(T2Arr,(SNR_eff_STE*100),'linewidth',4)
hold all;plot(T2Arr,(SNR_eff_SE*100),'linewidth',4)
