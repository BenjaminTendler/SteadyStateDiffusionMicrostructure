...
%%
%Define Gradient amplitude - Note that fitting algorithm will fix the gradient amplitude during the optimisation
GArr=20:20:1000;
%%
...
%%
%SSFP Optimisation
for k=length(GArr):-1:1
    optScanner.GMax=GArr(k);
...
%%
%Plot
figure;plot(GArr,(SNR_eff_SSFP*100),'linewidth',4)
hold all;plot(GArr,(SNR_eff_STE*100),'linewidth',4)
hold all;plot(GArr,(SNR_eff_SE*100),'linewidth',4)
legend('DW-SSFP','DW-STE','DW-SE','Location','southeast');
